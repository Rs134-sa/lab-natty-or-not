...
- comunicação clara de temas tecnológicos;
...
- Criação e revisão do roteiro com apoio do ChatGPT;

- Produção do vídeo com avatar e voz sintética no D-ID;
...
- peça de portfólio em tecnologia e inovação;

- material introdutório sobre IA generativa;
